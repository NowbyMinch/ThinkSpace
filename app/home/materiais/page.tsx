...
type MateriaDataItem = {
  ...
  quantidadeMateriais: number;
  tempoAtivo: number; // 0
  ultimaRevisao: string; // ISO date string
  usuarioId: string;
  materiaId?: string;
...
export default function Materiais() {
  ...
  // Dados de matérias
  const [materias, setMaterias] = useState<MateriaDataItem[]>([]);
  ...
  useEffect(() => {
    setTemp([
      {
        nome: criarMateria.nome,
        cor: criarMateria.cor,
        icone: criarMateria.cor,
      },
    ]);
  }, []);
  ...
  return (
    <>
      ...
      <AnimatePresence initial={false}>
        {open && (
          ...
          >
            ...
            <div
              id="white-box"
              className={`w-[1250px] max-w-[95%] min-h-[95%] lg:min-h-[650px] h-[650px] max-h-[95%] rounded-[50px] z-[1100] left-[50%] translate-x-[-50%] top-[50%] translate-y-[-50%] bg-white shadow-md flex justify-center items-center relative overflow-hidden `}
            >
              <X
              ...
              <div className=" w-[90%] h-[90%] lg:w-[80%] lg:h-[92%] mt-auto lg:mb-4 flex flex-col items-center gap-10 z-[900] overflow-y-auto pr-2 pb-4">
                ...
                <div className="w-full flex lg:flex-row flex-col justify-between lg:gap-0 gap-4">
                        ...
                        {colors.map((color) => (
                          <motion.button
                            ...
                            onClick={() => {
                              setCriarMateria({
                                ...criarMateria,
                                cor: cor[color as keyof typeof cor],
                              });
                              setColor(color);
                            }}
                        ...
                        <div className=" max-w-[92%] overflow-y-auto h-[85%] flex flex-wrap gap-2 overflow-x-hidden items-center pb-1">
                          {icons.map(({ id, Icon }) => (
                            <motion.button
                              ...
                              key={id}
                              onClick={() => {
                                setCriarMateria({ ...criarMateria, icone: id });
                                setSelected(id);
                              }}
                            >
                  ...
                  <div className=" w-[438px] max-w-full lg:w-[47%] lg:mx-0 mx-auto">
                    <div className=" w-full h-[320px] lg:h-full max-h-[320px] rounded-[25px] bg-[#EFEFEF] flex flex-col items-center justify-center">
                      <h2 className="w-[85%] h-[60px] flex font-medium text-[25px]">
                        Pré-visualização:
                      </h2>
                      <div
                        style={{ backgroundColor: color || "white" }}
                        className="w-[85%] h-[70%] max-h-[220px] rounded-[25px] flex justify-center items-center"
                      >
                        <div className="w-[85%] h-[85%] flex items-center">
                          <div
                            className={`${selected ? "w-[54%]" : "w-full"} flex flex-col gap-4`}
                          >
                            <h1 className="w-[210px] line-clamp-2 break-words material_title leading-none font-medium ">
                              {criarMateria.nome?.trim() !== ""
                                ? criarMateria.nome
                                : "Nome da matéria"}
                            </h1>
                            <div className="text-[18px]">
                              <h2 className="material_text leading-none">
                                Materiais de estudo: 0
                              </h2>
                              <h2 className="material_text leading-none">
                                Tempo ativo: 0
                              </h2>
                            ...
                            {selected && (
                              <>
                                {(() => {
                                  ...
                                  return SelectedIcon ? (
                                    <SelectedIcon className=" size-[100px] lg:size-[130px] opacity-[22%] stroke-1" />
                                  ) : null;
                                })()}
                              </>
                            )}
                ...
                <motion.button
                  ...
                  whileHover={{ scale: 1.02 }}
                  id="editar_conta"
                  className=" border border-[#1E2351] text-[18px] p-[5px_30px] rounded-full"
                  onClick={() => criar()}
                >
                  Criar nova matéria
                </motion.button>
            ...
            >
              ...
              <div className=" w-[90%] h-[90%] lg:w-[80%] lg:h-[92%] mt-auto lg:mb-4 flex flex-col items-center gap-10 z-[900] overflow-y-auto pr-2 pb-4">
                    ...
                    <div className=" w-full h-[320px] lg:h-full max-h-[320px] rounded-[25px] bg-[#EFEFEF] flex flex-col items-center justify-center">
                      ...
                      <div
                        style={{
                          backgroundColor:
                            criarMateria.cor &&
                            cores[criarMateria.cor as keyof typeof cores]
                              ? cores[criarMateria.cor as keyof typeof cores]
                              : cores[temp[0].cor as keyof typeof cores],
                        }}
                        className="w-[85%] h-[70%] max-h-[220px] rounded-[25px] flex justify-center items-center"
                      >
                        <div className="w-[85%] h-[85%] flex items-center">
                            ...
                            {(() => {
                              if (criarMateria.icone) {
                                const IconComponent = icons.find(
                                  (icon) =>
                                    icon.id.toLowerCase() ===
                                    criarMateria.icone?.toLowerCase()
                                )?.Icon;
                                if (IconComponent) {
                                  return (
                                    <IconComponent className=" size-[100px] lg:size-[130px] opacity-[22%] stroke-1" />
                                  );
                                }
                                return null;
                              } else {
                ...
                <motion.button
                  ...
                  className=" border border-[#1E2351] text-[18px] p-[5px_30px] rounded-full"
                  onClick={() => {
                    if (temp[0]?.id) editarMateria(temp[0].id, criarMateria);
                  }}
                >
                  Salvar edição
                </motion.button>
                ...
                >
                  ...
                  <div className="w-[80%] h-[85%] flex flex-col items-center gap-2 z-[900] ">
                    ...
                    <h1 className="text-center text-[20px] font-medium">
                      Você deseja mesmo deletar essa matéria?
                    </h1>
      ...
      {open && <Backdrop3 onClick={() => closing()} />}
      {editar && <Backdrop3 onClick={() => closing()} />}
        ...
        <div className=" w-full rounded-[35px] overflow-hidden bg-white h-full flex flex-col items-center shadow-md border border-[#00000031]">
          <div className="w-[95%] max-w-[95%] mt-4 ">
            <div className="w-full mx-auto">
              ...
              <h1 className="font-medium text-[18px] text-[#A19797] ">
                {" "}
                Qual matéria será revisada hoje?{" "}
              </h1>
            </div>
          ...
          <div
            className={`w-[95%] max-w-[95%] ${materias && materias.length === 0 ? "" : "grid-cols-[1fr_1fr]"} grid gap-[10px] max-h-[880px] pt-1 pb-3 overflow-y-auto px-2`}
          >
                ...
                <div className="ml-10 w-full lg:w-[60%] h-[90%] flex justify-center items-center">
                  <div className=" flex flex-col justify-center gap-[10%] w-full h-full  ">
                    <h1 className="text-[22px] font-medium line-clamp-3 break-words">
                      Nenhuma matéria criada ainda. Comece agora e organize seu
                      caminho rumo ao sucesso!
                    </h1>

                    <Link
                      href="/home/materiais"
                      className="w-[40%] min-w-[40%] h-[30%] min-h-[30%] rounded-full"
                    >
                      <button
                        onClick={() => setOpen(true)}
                        className="p-[10px_12px] bg-[#1E2351] rounded-full text-white flex justify-center items-center gap-2 text-[20px] shadow-md leading-5 "
                      >
            ...
            {materias && materias.length > 0 && (
              <>
                <motion.div
                  ...
                  id="materias"
                  onClick={() => setOpen(true)}
                  className="material bg-[#D8D8D8] border-[3px] border-[rgb(0,0,0,22%)] rounded-[28px] cursor-pointer flex justify-center items-center flex-col "
                >
                  <CirclePlus className="text-[rgb(165,165,165)] size-[50px]" />
                  <h2 className="text-[25px] text-[rgb(48,38,42,87%)] leading-none font-medium text-center material_title">
                    Criar matéria
                  </h2>
                </motion.div>
                <AnimatePresence>
                      ...
                      return (
                        ...
                        >
                          <motion.div
                            ...
                            transition={{ duration: 0.25, ease: "easeInOut" }}
                            id="materias"
                            className="material rounded-[28px] cursor-pointer flex justify-center items-center flex-row gap-5 shadow-md border border-[#00000031]"
                            style={{
                              backgroundColor:
                                material.cor &&
                          ...
                          >
                            ...
                            <Link
                              ...
                              className="w-full h-full flex justify-center rounded-[28px]"
                            >
                              <div className="w-[90%] max-w-[90%] h-full flex rounded-[28px] gap-[4%] justify-center items-center">
                                <div className="max-w-[100%] xl:max-w-[85%] max-h-[80%] overflow-hidden">
                                  <div className="flex justify-between">
                                    <h2 className="material_title text-[25px] w-fit max-w-[80%] line-clamp-2 break-words leading-none text-[rgb(48,38,42,87%)] font-medium">
                                      {material.nome}
                                    </h2>
                                    ...
                                    {(() => {
                                      ...
                                      if (IconComponent) {
                                        return (
                                          <IconComponent className="md:hidden flex size-[30px] opacity-[50%] stroke-1" />
                                        );
                                      }
                                      return null;
                                    })()}
                                  ...
                                  {/* Corrigido: renderiza a quantidade de materiais */}
                                ...
                                {(() => {
                                  ...
                                  if (IconComponent) {
                                    return (
                                      <IconComponent className="size-[130px] hidden md:flex max-w-[45%] opacity-[22%] stroke-1" />
                                    );
                                  }
                                  return null;
                                })()}
              ...
              <div className="flex flex-col gap-1 mt-2 items-center relative w-full overflow-y-auto overflow-x-hidden pb-3 ">
                {recente.map((materia, index) => {
                  return (
                    <Link
                      key={index}
                      href={`/home/materiais/${materia.id}`}
                      className="px-1 flex gap-3 py-1 w-full rounded-[15px] ml-[15px] mr-[15px] cursor-pointer hover:bg-[rgba(0,0,0,0.06)] "
                    >
