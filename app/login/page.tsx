      ...
      <AnimatePresence>
        <div className="w-full h-[100vh] flex justify-center bg-white">
          ...
          <div className="logincontainer w-[1600px] py-5 m-auto max-w-[90%] mx-auto flex lg:flex-row flex-col justify-center items-center">
            ...
            <motion.div
              key="login"
              className="login  w-[90%] lg:max-w-[50%] flex justify-center items-center"
            >
              <div className=" flex flex-col w-[500px] gap-[20px] max-w-[100%] h-full ">
                <div className="">
                  <h1 className="entrar text-[30px] font-bold leading-none text-[#EB7262]">
                    Entrar
                  </h1>
                  <h2 className="bemvindo text-[18px] ">
                    Bem-vindo de volta! Pronto para mais um dia de aprendizado?
                  </h2>
                </div>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-1 ">
                  <div className="flex flex-col gap-4 items-end">
                    <input
                      ...
                      className="p-3 w-full rounded-[25px] outline-[rgba(151,103,248,0.6)] text-[18px] border-2 border-[rgba(10,8,9,0.6)]"
                    />
