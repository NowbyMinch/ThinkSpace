...
const items: AccordionItem[] = [
  {
    title:
      "O que torna o ThinkSpace diferente das outras plataformas de estudo?",
    content:
  ...
  return (
    <>
      <div className=" z-[0] relative overflow-x-hidden p-0 m-0">
            ...
            <div className="lg:flex w-full hidden justify-center items-center ">
              <div id="links-header" className="flex justify-between gap-2">
                ...
                <motion.a
                  whileHover={{ scale: 1.03 }}
                  whileTap={{ scale: 0.97 }}
                  className="cursor-pointer leading-none text-center text-nowrap"
        ...
        <div
          className={`${showHeader ? "translate-y-0" : "-translate-y-full"} w-[100%] h-[100px] `}
        ></div>
        ...
        <main className="flex justify-center items-center flex-col gap-[80px] md:gap-[150px] overflow-hidden ">
          <div className="w-full relative flex justify-center items-center">
            <div className="w-full object-center flex justify-center items-center overflow-hidden ">
              <img
                ...
                className=" min-w-[800px] md:-mt-10 lg:-mt-16 xl:-mt-20 2xl:-mt-28 w-full"
              />
            </div>
            ...
            <div className="absolute flex justify-center h-[85%] w-[90%] ">
              <div className="back_title w-[580px] max-w-[80%] ml-[7%] mr-auto text-[70px] h-fit flex flex-col justify-center items-start ">
                <h1 className="title overflow-ellipsis  line-clamp-4 break-words w-full text-[40px] text-white leading-none">
                  Estude de maneira mais{" "}
                  <span id="conf" className="title text-[#FF92EE] text-[40px]">
                    rápida
                  </span>{" "}
                  e{" "}
                  <span id="conf" className="title text-[#5F3AC4] text-[40px] ">
                    eficiente
                  </span>
                </h1>
                <p className="jeito text-[18px] text-white break-words w-full">
                  O jeito inteligente de aprender mais em menos tempo.
                </p>
                ...
                >
                  <a
                    href="/registrar"
                    className="comece line-clamp-2 break-words "
                  >
                    Comece a estudar
                  </a>
                  <div className="bg-white p-2 rounded-full ">
                    {" "}
                    <MoveUpRight className="text-[#A39CEC] size-3" />{" "}
                  </div>
                </motion.button>
              </div>
            </div>
          ...
          <div className="w-[1300px] max-w-[90%] flex flex-col justify-center items-center gap-7 -mt-[150px]">
            <div className="w-full text-[55px] flex justify-between items-center">
              ...
              <Image
                ...
                width={500}
                height={300}
                src="/landingpage/func-vector.svg"
                alt="Vector"
                className="w-[350px]"
              />
            </div>
            ...
            <div className="flex flex-col w-full md:h-[740px] gap-5">
              <div className="h-full flex md:flex-row flex-col gap-5">
                <div
                  id="func-boxes"
                  className="w-full md:w-[33%] bg-[#B697F5] h-[200px] md:h-full shadow-md rounded-[45px] relative overflow-hidden flex flex-col justify-center md:justify-end items-center"
                >
                  <Image
                    width={300}
                    height={500}
                    src="/landingpage/func1.svg"
                    alt="Funcionalidade 1"
                    className="absolute md:top-0 -bottom-16 hidden right-0 md:flex w-[100%] md:w-[85%] lg:w-[75%] "
                  />
                  <div className=" w-[90%] md:w-[80%] md:min-h-[50%] flex flex-col z-10 md:mb-5">
                    <h1 className="text-[25px] font-bold line-clamp-1 break-words ">
                      Quizzes
                    </h1>
                    <p className="text-[18px] break-words ">
                      Descubra quizzes feitos pela comunidade ou crie os seus
                      próprios para testar conhecimentos e compartilhar com
                      outras pessoas.
                    </p>
                  </div>
                </div>
                <div
                  id="func-boxes"
                  className="w-full md:w-[33%] bg-[#FFB0F3] h-[200px] md:h-full shadow-md rounded-[45px] relative overflow-hidden flex flex-col justify-center md:justify-end items-center"
                >
                  <Image
                    width={300}
                    height={500}
                    src="/landingpage/func2.svg"
                  ...
                  <div className=" w-[90%] md:w-[80%] md:min-h-[50%] flex flex-col z-10 md:mb-5">
                    ...
                    <p className="text-[18px] break-words ">
                      Uma comunidade aberta para trocar ideias, compartilhar
                      conteúdos e se conectar com pessoas que compartilham seus
                      interesses.
                    </p>
                  </div>
                </div>
                <div
                  id="func-boxes"
                  className="w-full md:w-[33%] bg-[#9678FF] h-[200px] md:h-full shadow-md rounded-[45px] relative overflow-hidden flex flex-col justify-center md:justify-end items-center"
                >
                  <Image
                    width={300}
                    height={500}
                    src="/landingpage/func3.svg"
                    alt="Funcionalidade 3"
                    className="absolute md:top-4 -bottom-16 hidden right-0 md:flex w-[100%] md:w-[85%] lg:w-[75%] "
                  />
                  <div className=" w-[90%] md:w-[80%] md:min-h-[50%] flex flex-col z-10 md:mb-5">
                    <h1 className="text-[25px] font-bold line-clamp-1 break-words ">
                      Materiais
                    ...
                    <p className="text-[18px] break-words ">
                      Geração automática de materiais de estudo com IA, a partir
                      de documentos enviados ou tópicos personalizados.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="min-h-[46%] flex gap-5 flex-col md:flex-row">
                <div
                  id="func-boxes"
                  className="bg-[#A67EF6] shadow-md h-[200px] md:h-full rounded-[45px] relative overflow-hidden flex flex-col justify-center md:justify-end items-center"
                >
                  <Image
                    width={300}
                    height={500}
                    src="/landingpage/func4.svg"
                  ...
                  <div className=" w-[90%] md:w-[80%] md:min-h-[50%] flex flex-col md:mb-5 ">
                    ...
                    <p className="text-[18px] break-words ">
                      Acompanhe seu progresso, visualize suas conquistas e
                      descubra insights que ajudam você a aprender melhor a cada
                      dia.
                    </p>
                  </div>
                </div>
                <div
                  id="func-boxes"
                  className="bg-[#FF80EB] shadow-md h-[200px] md:h-full rounded-[45px] relative overflow-hidden flex flex-col justify-center md:justify-end items-center"
                >
                  <Image
                    width={300}
                    height={500}
                  ...
                  <div className=" w-[90%] md:w-[80%] md:min-h-[50%] flex flex-col md:mb-5 ">
                    ...
                    <p className="text-[18px] break-words ">
                      Organize sua rotina, planeje seus estudos e nunca perca um
                      prazo com um calendário feito para acompanhar seu ritmo.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div
            ...
            className="w-[1300px] sm:h-[550px] sm:gap-0 gap-4 max-w-[90%] flex flex-col sm:flex-row justify-center "
          >
            <div className="w-full flex flex-col gap-10 ">
              <h1 id="title" className="w-full ">
                ...
                <Image
                  width={300}
                  height={500}
                  className="absolute top-0 left-[-38px] w-[30%] -z-10"
                  src="/landingpage/aprendervec.svg"
                  alt="Vector"
                />
              </h1>
              <p id="animate" className="text-[18px]">
                Nossa missão é simples: tornar o estudo mais inteligente,
                acessível e personalizado para todos os estudantes, em qualquer
                fase da vida. Na ThinkSpace, criamos planos de estudo
                estratégicos, pensados para economizar tempo, reduzir o estresse
                e ajudar cada pessoa a alcançar seus objetivos com mais foco e
                confiança. Acreditamos que aprender não precisa ser complicado —
                e com o plano certo, tudo flui melhor.
              </p>
              <motion.button
                whileTap={{ scale: 0.98 }}
                whileHover={{ scale: 1.02 }}
              ...
              >
                <a href="/registrar" className="line-clamp-2 break-words">
                  Comece a estudar
                </a>
                <div className="bg-[#704FE6] p-3 rounded-full ">
                  {" "}
                  <MoveUpRight className="text-white size-5" />{" "}
                </div>
              </motion.button>
            ...
            <div
              id="animate"
              className=" w-full sm:h-full flex h-[370px] justify-center"
            >
              <img
                src="/landingpage/facil.svg"
                alt="Banner"
                className=" h-full "
              />
            </div>
          ...
          <div className="w-full h-[850px] bg-[#9767F8] flex flex-col justify-center items-center ">
            <div className="w-[1300px] h-[80%] max-w-[95%]  relative flex flex-col items-center ">
              <Image
                width={300}
                height={800}
                src="/landingpage/materiaisvec.svg"
                alt="Banner"
              ...
              <div className="flex flex-col items-center gap-[100px] w-full h-full ">
                <h1
                  id="animate"
                  className="text-white text-center text-[30px] w-[750px] max-w-full h-fit"
                >
                  Nossos materiais tornam o aprendizado divertido e acessível
                    ...
                    <div className="embla__viewport " ref={emblaRef}>
                      <div className="embla__container ">
                        <div className="embla__slide flex flex-col gap-3 items-center  ">
                          <Image
                            src="/landingpage/materiais-img1.svg"
                            className="max-h-[200px]"
                            width={300}
                            height={500}
                            alt="Alt"
                          />
                          <h1 className=" h-[60px] text-white text-[25px] leading-8 max-w-[230px] text-center flex justify-center   break-words">
                            Professora de Ciências
                          </h1>
                          <h2 className="embla_text text-white max-w-[230px] text-center text-[18px] break-words">
                            Ajuda pré-universitários a explorarem o mundo com
                            curiosidade e foco no vestibular.
                          </h2>
                        </div>
                        <div className="embla__slide flex flex-col gap-3 items-center ">
                          <Image
                            src="/landingpage/materiais-img2.svg"
                            className="max-h-[200px]"
                            width={300}
                            height={500}
                            alt="Alt"
                          ...
                          <h2 className="embla_text text-white max-w-[230px] text-center text-[18px]">
                            Inspira estudantes a desenvolverem a criatividade
                            através do desenho e expressão visual.
                          </h2>
                        </div>
                        <div className="embla__slide flex flex-col gap-3 items-center ">
                          <Image
                            src="/landingpage/materiais-img3.svg"
                            className="max-h-[200px]"
                            width={300}
                            height={500}
                            alt="Alt"
                          ...
                          <h2 className="embla_text text-white max-w-[230px] text-center text-[18px]">
                            Ensina com entusiasmo, conectando o raciocínio
                            lógico ao dia a dia universitário.
                          </h2>
                        </div>
                        <div className="embla__slide flex flex-col gap-3 items-center ">
                          <Image
                            src="/landingpage/materiais-img4.svg"
                            className="max-h-[200px]"
                            width={300}
                            height={500}
                            alt="Alt"
                          />
                          <h1 className=" h-[60px] text-white text-[25px] leading-8 max-w-[230px] text-center flex justify-center ">
                            Estudante amante de leitura
                          </h1>
                          <h2 className="embla_text text-white max-w-[230px] text-center text-[18px]">
                            Descobre novos mundos através dos livros e
                            compartilha conhecimento com alegria.
                          </h2>
                        </div>
                        <div className="embla__slide flex flex-col gap-3 items-center ">
                          <Image
                            src="/landingpage/materiais-img5.svg"
                            className=" max-h-[200px]"
                            width={300}
                            height={500}
                            alt="Alt"
                          ...
                          <h2 className="embla_text text-white max-w-[230px] text-center text-[18px]">
                            ...
                            inovação, com sede de descobertas.
                          </h2>
                        </div>
                      </div>
                    </div>
          ...
          <div className="w-full pb-20 flex justify-center relative">
            <div
              ...
              className="w-[1300px] max-w-[90%] flex flex-row justify-center"
            >
              <div className="w-full flex flex-col relative ">
                <h1 id="title" className="preco w-full flex flex-col">
                  Nossos planos
                </h1>

                <h1 className="my-2 preco w-full text-center text-[22px] text-gray-400 flex justify-center gap-2">
                  <BadgeAlert className="h-full" />
                  Como a plataforma ainda está em versão beta, os planos
                  previstos ainda não foram colocados em prática, estando
                  sujeitos a ajustes.
                </h1>
                ...
                <div className="flex justify-between flex-col md:flex-row md:gap-0 gap-6 items-center relative preco_box ">
                  ...
                  >
                    <div className="absolute preco_img top-[-65px] left-[-60px] h-[35%] -z-10">
                      <Image
                        src="/landingpage/gratis.svg"
                        alt="Perguntas Frequentes Vector"
                        className="w-full"
                        width={300}
                        height={500}
                      />
                    ...
                    <div className=" w-fit max-w-[90%] flex justify-end items-end min-h-fit md:h-[20%] ">
                      ...
                      <span className="text-[105px] font-medium leading-[80px] valoR">
                        00
                      </span>
                  ...
                  >
                    ...
                    <div className="box_preco w-fit md:w-[85%] flex min-h-fit md:h-[40%]">
                      <ul className="ul_preco text-[18px] flex flex-col text-[#000] list-disc pl-3">
                        ...
                        <li className="max-w-[242px]">
                          3 salas de estudo por mês
                        </li>
                        <li className="max-w-[242px]">
                          50 mensagens para o chat de IA
                        </li>
                        <li className="max-w-[242px]">
                          20 materiais de estudo por mês
                        </li>
                  ...
                  >
                    ...
                    <div className="box_preco w-fit md:w-[85%] flex min-h-fit md:h-[40%]">
                      <ul className="ul_preco text-[18px] flex flex-col text-[#000] list-disc pl-3">
                        ...
                        <li className="max-w-[242px]">
                          5 salas de estudo por mês
                        </li>
                        <li className="max-w-[242px]">
                          150 mensagens para o chat de IA
                        </li>
                        <li className="max-w-[242px]">
                          40 materiais de estudo por mês
                        </li>
                        <li className="max-w-[242px]">Sem anúncios</li>
                      </ul>
                    </div>
          ...
          <div
            ...
            className="w-full h-[635px] flex gap-[150px] relative"
          >
            <div className="w-full h-full absolute ">
              <img
                src="/landingpage/perguntasvec.svg"
                alt="Perguntas Frequentes Vector"
                className="w-[800px] -z-100"
              />
            </div>
              ...
              {items.map((item, index) => (
                ...
                >
                  ...
                  >
                    ...
                    <span
                      className={`text-[20px] text-[rgba(151,103,248,1)] transform transition-transform duration-300 flex justify-center items-center rounded-full 
                                        ${
                                          openIndex === index
                                            ? "-rotate-90"
                                            : ""
