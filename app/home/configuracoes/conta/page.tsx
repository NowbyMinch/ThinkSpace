...
export default function Conta() {
  ...
  const deletarConta = async () => {
    try {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/configuracoes/excluir-conta`,
        {
          method: "DELETE",
          credentials: "include",
  ...
  const suspenderConta = async () => {
    try {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/configuracoes/suspender-conta`,
        {
          method: "PATCH",
          credentials: "include",
          headers: { "Content-Type": "application/json" },
  ...
  const Step = async () => {
    if (step === 1) {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/configuracoes/email/solicitar`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
      ...
      const res2 = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/configuracoes/email/enviar-codigo`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          credentials: "include",
      ...
      if (
        data.message === "Email para troca enviado com sucesso." ||
        data.message ===
          "Solicitação de troca de email registrada. Siga as instruções enviadas."
      ) {
        setStep(2);
      } else {
      ...
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/configuracoes/email/verificar-codigo`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
      ...
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/configuracoes/email/confirmar`,
        {
          method: "PATCH",
          credentials: "include",
          headers: { "Content-Type": "application/json" },
      ...
      if (
        data.message === "Email alterado com sucesso." ||
        data.message === "Email alterado com sucesso e registros atualizados."
      ) {
        setStep(1);
        closing();
        const res = await fetch(
  ...
  const StepSenha = async () => {
    if (stepSenha === 1) {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/configuracoes/senha/solicitar`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
      ...
      const res2 = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/configuracoes/senha/enviar-codigo`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          credentials: "include",
      ...
      if (
        data.message ===
        "Solicitação de troca de senha registrada. Siga as instruções enviadas."
      ) {
        setStepSenha(2);
      } else {
        setMessage(data.message);
      ...
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/configuracoes/senha/verificar-codigo`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({ codigo: codigo.code.toString() }),
      ...
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/configuracoes/senha/confirmar`,
        {
          method: "PATCH",
          credentials: "include",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
            ...
            confirmarSenha: confirmarNovaSenha.confirmarNovaSenha,
            codigo: codigo.code.toString(),
          }),
        }
      );
        ...
        {editarEmailPop && (
          <>
            ...
            >
              ...
              <div
                id="white-box"
                className={`w-[1200px] max-w-[95%] min-h-[95%] lg:min-h-[600px] h-[600px] max-h-[95%] rounded-[50px] z-[1100] bg-white shadow-md flex justify-center items-center relative overflow-hidden `}
              >
                <ArrowLeft
                  onClick={() => {
                    setStep(step - 1);
                  }}
                  className={`size-6 text-black flex cursor-pointer h-fit absolute top-5 left-8 z-10 ${step > 1 ? "flex" : "hidden"}`}
                />
                <X
                ...
                <form
                  ...
                  className={`w-[90%] h-[85%] lg:w-[80%] lg:h-[85%] lg:mb-4 flex flex-col items-center ${step === 1 || step === 3 ? "gap-10" : "gap-0"} z-[900] overflow-y-auto pr-2 pb-4`}
                >
                  <div className="h-fit w-full flex flex-col justify-center items-center">
                    <h1
                      className={`text-center text-[30px] font-medium text-[#EB7262]`}
                    >
                      Deseja editar seu email?
                    </h1>
                    <h2
                      className={`text-center text-[25px] w-[700px] max-w-full font-medium break-words ${step === 1 ? "flex" : "hidden"}`}
                    >
                      Insira o seu email e enviaremos um código de verificação
                      para você editar sua conta.
                    </h2>
                    <h2
                      className={`text-center text-[25px] w-[700px] max-w-full font-medium break-words ${step === 2 ? "flex" : "hidden"}`}
                    >
                      Um e-mail de confirmação foi enviado. Digite o código de
                      verificação para redefinir sua conta com segurança.
                    </h2>
                    <h2
                      className={`text-center text-[25px] w-[700px] max-w-full font-medium break-words ${step === 3 ? "flex" : "hidden"}`}
                    >
                      Para atualizar sua conta, digite o novo e-mail que deseja
                      utilizar. Esse será o endereço principal para acessar a
                      plataforma e receber as nossas notificações.
                    </h2>
                  </div>
                      ...
                      return (
                        <>
                          ...
                          <motion.button
                            ...
                            type="submit"
                            className="w-full max-w-[300px] bg-[#804EE5] py-[10px] text-white text-[18px] rounded-[25px] shadow-md"
                          >
                            Enviar código
                          </motion.button>
                        </>
          ...
          <>
            ...
            >
              ...
              >
                <ArrowLeft
                  onClick={() => {
                    setStepSenha(stepSenha - 1);
                  }}
                  className={`size-6 text-black flex cursor-pointer h-fit absolute top-5 left-8 z-10 ${stepSenha > 1 ? "flex" : "hidden"}`}
                />
                <X
                  className="absolute top-5 right-8 size-6 cursor-pointer"
                  onClick={() => closing()}
                ...
                <form
                  ...
                  className={`w-[90%] h-[85%] lg:w-[80%] lg:h-[85%] lg:mb-4 flex flex-col items-center ${stepSenha === 1 || stepSenha === 3 ? "gap-10" : "gap-0"} z-[900] overflow-y-auto pr-2 pb-4`}
                >
                  <div className="h-fit w-full flex flex-col justify-center items-center ">
                    <h1
                      className={`text-center text-[30px] font-medium text-[#EB7262]`}
                    ...
                    <h2
                      className={`text-center text-[25px] w-[700px] max-w-full font-medium break-words ${stepSenha === 1 ? "flex" : "hidden"}`}
                    >
                      Insira o seu email e enviaremos um código de verificação
                      para você editar sua conta.
                    </h2>
                    <h2
                      className={`text-center text-[25px] w-[700px] max-w-full font-medium break-words ${stepSenha === 2 ? "flex" : "hidden"}`}
                    >
                      Um e-mail de confirmação foi enviado. Digite o código de
                      verificação para redefinir sua conta com segurança.
                    </h2>
                    <h2
                      className={`text-center text-[25px] w-[700px] max-w-full font-medium break-words ${stepSenha === 3 ? "flex" : "hidden"}`}
                    >
                      Crie uma nova senha com pelo menos 8 caracteres, incluindo
                ...
                >
                  ...
                  <div className="w-[80%] h-[85%] flex flex-col items-center gap-2 z-[900] ">
                    ...
                    <h1 className="text-center text-[20px] font-medium">
                      Você deseja mesmo deletar sua conta?
                    </h1>
                    <div className="relative w-full max-w-[450px]">
                      <input
                        type={showPassword ? "text" : "password"}
              ...
              >
                ...
                >
                  ...
                  <div className="w-[80%] h-[85%] flex flex-col items-center gap-2 z-[900] ">
                    ...
                    <h1 className="text-center text-[20px] font-medium">
                      Você deseja mesmo suspender sua conta?
                    </h1>
                    <div className="relative w-full max-w-[450px]">
                      <input
                        type={showPassword ? "text" : "password"}
      ...
      <div className=" mt-4 flex flex-col gap-5 ">
        ...
        <div className="flex gap-2 w-full items-center ">
          <div className="flex flex-col justify-between lg:min-w-[650px] lg:max-w-[650px] w-full gap-4">
            ...
            <p className="text-[18px] ">
              Sua conta será suspensa, mas você poderá reativá-la a qualquer
              momento fazendo login novamente. Se nenhum acesso for feito dentro
              de 30 dias, a conta será excluída permanentemente.
            </p>
          </div>
